...
class Config{
  ...
  final String channelId = dotenv.get('NOTIFICATION_CHANNEL_ID');
  final String channelName = dotenv.get('NOTIFICATION_CHANNEL_NAME');
  final String channelDescription = dotenv.get('NOTIFICATION_CHANNEL_DESCRIPTION');
