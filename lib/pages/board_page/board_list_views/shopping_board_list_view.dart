...
class ShoppingBoardListView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => GetBuilder<ShoppingBoardListController>(
    init: ShoppingBoardListController(),
    builder: (ShoppingBoardListController controller) {
