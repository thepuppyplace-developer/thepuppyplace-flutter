...
class CafeBoardListView extends StatefulWidget {
  ...
  @override
  State<CafeBoardListView> createState() => _CafeBoardListViewState();
}

class _CafeBoardListViewState extends State<CafeBoardListView> {
  final RefreshController _refreshController = RefreshController();

  @override
  Widget build(BuildContext context) => Scrollbar(
    child: GetBuilder<CafeBoardListController>(
        autoRemove: false,
